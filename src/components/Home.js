...
const Sidebar = ({ handleEditDetails, handleChangePassword }) => (
  <div className="sidebar">
    <ul>
      ...
      <li>
        <FontAwesomeIcon icon={faFileInvoiceDollar} /> Profile
      </li>
      <li>
...
const Home = () => {
  ...
  const handleEditDetails = async () => {
    try {
      ...
      const { mobileNumber, username } = response.data;

      setFormDatas({ mobileNumber, username });
  ...
  const handleEditDetailsSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(
        "http://localhost:5000/edit-details",
        formDatas
      );
      ...
      if (response.status === 200) {
        ...
        setFormDatas({ ...formDatas, newMobileNumber: formDatas.mobileNumber });

        // Or refetch updated user details if needed
        // Example: const updatedUserDetails = await fetchUserDetails();
  ...
  return (
    <Container fluid>
        ...
        <Col md={9} className="content">
          <Row>
            <Col md={4}>
              <CardComponent
                title="Add Details"
                value="Details about adding something here"
            ...
            <Col md={4}>
              <CardComponent
                title="Transactions"
                value="Details about transactions"
              />
            </Col>
            <Col md={4}>
              <CardComponent
                title="Edit Details"
                value="Click to edit user details"
      ...
      <Modal
        ...
        onHide={handleCloseEditDetailsModal}
        centered
      >
        <Modal.Header closeButton>
